...
protected:
  ...
  virtual void switchedMatrixStamp(
      std::size_t index,
      std::vector<std::shared_ptr<CPS::MNAInterface>> &comp) = 0;
  ...
  virtual void solveWithSystemMatrixRecomputation(Real time,
                                                  Int timeStepCount) = 0;
  ...
  virtual void solveWithHarmonics(Real time, Int timeStepCount,
                                  Int freqIdx) = 0;
