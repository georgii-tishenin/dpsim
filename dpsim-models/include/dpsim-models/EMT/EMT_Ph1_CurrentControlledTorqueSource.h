...
class CurrentControlledTorqueSource : public MNASimPowerComp<Real>,
...
public:
  ...
  std::shared_ptr<Inductor> mInductor;
  ...
  void setInductorForCurrentRerefence(const std::shared_ptr<Inductor> &pt) {
    mInductor = pt;
  }
