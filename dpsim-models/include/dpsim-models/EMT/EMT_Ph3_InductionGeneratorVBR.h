...
class InductionGeneratorNRCF : public MNASimPowerComp<Real>,
                             public MNAVariableCompInterface,
                             public SharedFactory<InductionGeneratorNRCF> {
protected:

  /// Physical parameters
  Real mLls; // Stator leakage inductance
  Real mLlr; // Rotor leakage inductance
  Real mLm;  // Magnetizing inductance
  Real mrs;  // Stator resistance
  Real mrr;  // Rotor resistance
  Real mOmegaRotor; // Rotor mechanical angular speed


  /// Transformed dq0 model inductance matrices

  Matrix mLssdq = Matrix::Zero(3, 3);
  Matrix mLrrdq = Matrix::Zero(3, 3);
  Matrix mLsrdq = Matrix::Zero(3, 3);
  Matrix mLrsdq = Matrix::Zero(3, 3);



  Matrix mIabcs = Matrix::Zero(3, 1); // Stator currents in abc frame
  Matrix mIabcr = Matrix::Zero(3, 1); // Rotor currents in abc frame
  Matrix mVabcs = Matrix::Zero(3, 1); // Stator voltages in abc frame
  Matrix mVabcr = Matrix::Zero(3, 1); // Rotor voltages in abc frame
...
public:
  ...
  SynchronGeneratorVBR(String name, String uid,
