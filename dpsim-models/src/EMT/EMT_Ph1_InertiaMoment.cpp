 ...
 *********************************************************************************/
 ...
 EMT::Ph1::InertiaMoment::InertiaMoment(String uid, String name, Logger::Level logLevel)
 ...
 SimPowerComp<Real>::Ptr EMT::Ph1::InertiaMoment::clone(String name) {
   auto copy = InertiaMoment::make(name, mLogLevel);
   copy->setParameters(**mCapacitance);
   return copy;
 }
 
 void EMT::Ph1::InertiaMoment::initializeFromNodesAndTerminals(Real frequency) {
 ...
 void EMT::Ph1::InertiaMoment::mnaCompInitialize(Real omega, Real timeStep,
   ...
   mEquivCurrent =
       -(**mIntfCurrent)(0, 0) + -mEquivCond * (**mIntfVoltage)(0, 0);
 }
 
 void EMT::Ph1::InertiaMoment::mnaCompApplySystemMatrixStamp(
 ...
 void EMT::Ph1::InertiaMoment::mnaCompApplyRightSideVectorStamp(
     Matrix &rightVector) {
   mEquivCurrent =
       -(**mIntfCurrent)(0, 0) + -mEquivCond * (**mIntfVoltage)(0, 0);
 ...
 void EMT::Ph1::InertiaMoment::mnaCompAddPreStepDependencies(
 ...
 void EMT::Ph1::InertiaMoment::mnaCompPreStep(Real time, Int timeStepCount) {
   mnaCompApplyRightSideVectorStamp(**mRightVector);
 }
 
 void EMT::Ph1::InertiaMoment::mnaCompAddPostStepDependencies(
     AttributeBase::List &prevStepDependencies,
     AttributeBase::List &attributeDependencies,
     AttributeBase::List &modifiedAttributes,
     Attribute<Matrix>::Ptr &leftVector) {
 ...
 void EMT::Ph1::InertiaMoment::mnaCompPostStep(Real time, Int timeStepCount,
                                           Attribute<Matrix>::Ptr &leftVector) {
   mnaCompUpdateVoltage(**leftVector);
   mnaCompUpdateCurrent(**leftVector);
 }
 
 void EMT::Ph1::InertiaMoment::mnaCompUpdateVoltage(const Matrix &leftVector) {
   // v1 - v0
   (**mIntfVoltage)(0, 0) = 0;
   if (terminalNotGrounded(1))
     (**mIntfVoltage)(0, 0) =
 ...
 void EMT::Ph1::InertiaMoment::mnaCompUpdateCurrent(const Matrix &leftVector) {
   (**mIntfCurrent)(0, 0) = mEquivCond * (**mIntfVoltage)(0, 0) + mEquivCurrent;
 }
 
 void EMT::Ph1::InertiaMoment::stampSignMatrix(UInt branchIdx,
                                           MatrixVar<Real> &signMatrix,
                                           Complex coeffDP) {
   signMatrix(branchIdx, branchIdx) = -1.0;
 }
 
 void EMT::Ph1::InertiaMoment::stampDiscretizationMatrix(
     UInt branchIdx, MatrixVar<Real> &discretizationMatrix, Complex coeffDP) {
   discretizationMatrix(branchIdx, branchIdx) = -2 * mEquivCond;
 }
 
 void EMT::Ph1::InertiaMoment::stampBranchNodeIncidenceMatrix(
