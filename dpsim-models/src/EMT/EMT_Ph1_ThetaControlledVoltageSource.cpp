#include <dpsim-models/EMT/EMT_Ph1_ThetaControlledVoltageSource.h>

using namespace CPS;

EMT::Ph1::ThetaControlledVoltageSource::ThetaControlledVoltageSource(
...
void EMT::Ph1::ThetaControlledVoltageSource::setInitialFlux(Real flux) {
  **mFlux = flux;
}

void EMT::Ph1::ThetaControlledVoltageSource::mnaCompInitialize(
    Real omega, Real timeStep, Attribute<Matrix>::Ptr leftVector) {
  updateMatrixNodeIndices();
  mTimeStep = timeStep;
}

void EMT::Ph1::ThetaControlledVoltageSource::mnaCompApplySystemMatrixStamp(
...
void EMT::Ph1::ThetaControlledVoltageSource::mnaCompAddPostStepDependencies(
...
void EMT::Ph1::ThetaControlledVoltageSource::mnaCompPostStep(
    Real time, Int timeStepCount, Attribute<Matrix>::Ptr &leftVector) {
  if (mVoltageReferenceNode == nullptr) {
    throw std::runtime_error(
        "mThetaNode is null in ThetaControlledVoltageSource.");
  }
  mV_a = mPhaseAReferenceNode->voltage()(0, 0);
  mV_b = mPhaseBReferenceNode->voltage()(0, 0);
  mV_c = mPhaseCReferenceNode->voltage()(0, 0);
}

void EMT::Ph1::ThetaControlledVoltageSource::stampBranchNodeIncidenceMatrix(
