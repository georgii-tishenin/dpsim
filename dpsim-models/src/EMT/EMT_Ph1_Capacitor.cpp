...
void EMT::Ph1::Capacitor::mnaCompInitialize(Real omega, Real timeStep,
...
void EMT::Ph1::Capacitor::mnaCompApplySystemMatrixStamp(
...
void EMT::Ph1::Capacitor::mnaCompApplyRightSideVectorStamp(
    Matrix &rightVector) {
  mEquivCurrent =
      -(**mIntfCurrent)(0, 0) + -mEquivCond * (**mIntfVoltage)(0, 0);
...
void EMT::Ph1::Capacitor::mnaCompAddPreStepDependencies(
...
void EMT::Ph1::Capacitor::mnaCompPostStep(Real time, Int timeStepCount,
                                          Attribute<Matrix>::Ptr &leftVector) {
