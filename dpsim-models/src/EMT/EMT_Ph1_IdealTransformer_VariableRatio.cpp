...
EMT::Ph1::IdealTransformerVariableRatio::IdealTransformerVariableRatio(String uid, String name,
 ...
 *mN = N;
  ...
  void EMT::Ph1::IdealTransformerVariableRatio::initializeFromNodesAndTerminals(Real frequency) {
...
void EMT::Ph1::IdealTransformerVariableRatio::mnaCompInitialize(Real omega, Real timeStep,
...
void EMT::Ph1::IdealTransformerVariableRatio::mnaCompApplySystemMatrixStamp(
  ...
  if (terminalNotGrounded(0)) {
    ...
    if (terminalNotGrounded(1)) {
        SPDLOG_LOGGER_INFO(mSLog, "Add {:s} to system at ({:d},{:d})",
                         Logger::complexToString(Complex(-1.0/(*mN), 0)), mVirtualNodes[0]->matrixNodeIndex(),
                         matrixNodeIndex(1));
        SPDLOG_LOGGER_INFO(mSLog, "Add {:s} to system at ({:d},{:d})",
                         Logger::complexToString(Complex(-1.0/(*mN), 0)),
  ...
  if (terminalNotGrounded(2)) {
    SPDLOG_LOGGER_INFO(mSLog, "Add {:s} to system at ({:d},{:d})",
                       Logger::complexToString(-1.0), mVirtualNodes[0]->matrixNodeIndex(),
                       matrixNodeIndex(2));
    SPDLOG_LOGGER_INFO(mSLog, "Add {:s} to system at ({:d},{:d})",
                       Logger::complexToString(-1.0),
                       matrixNodeIndex(2), mVirtualNodes[0]->matrixNodeIndex());
  }
  if(terminalNotGrounded(3)) {
    SPDLOG_LOGGER_INFO(mSLog, "Add {:s} to system at ({:d},{:d})",
                       Logger::complexToString(-1.0), mVirtualNodes[0]->matrixNodeIndex(),
    ...
    SPDLOG_LOGGER_INFO(mSLog, "Add {:s} to system at ({:d},{:d})",
                       Logger::complexToString(-1.0),
                       matrixNodeIndex(3), mVirtualNodes[0]->matrixNodeIndex());
  }
}
...
void EMT::Ph1::IdealTransformerVariableRatio::mnaCompPostStep(Real time, Int timeStepCount,
                                         Attribute<Matrix>::Ptr &leftVector) {
...
void EMT::Ph1::IdealTransformerVariableRatio::mnaCompUpdateVoltage(const Matrix &leftVector) {
  // v1 - v0
 /*
  (**mIntfVoltage)(0, 0) = 0;
  (**mIntfVoltage)(0, 0) =
...
void EMT::Ph1::IdealTransformerVariableRatio::mnaCompUpdateCurrent(const Matrix &leftVector) {
}


void EMT::Ph1::IdealTransformerVariableRatio::stampBranchNodeIncidenceMatrix(UInt branchIdx,
 ...
 double EMT::Ph1::IdealTransformerVariableRatio::getNumberOfBranches() {
   return 2;
 }
...
*/
  ...
  void EMT::Ph1::IdealTransformerVariableRatio::mnaCompPreStep(Real time, Int timeStepCount) {
